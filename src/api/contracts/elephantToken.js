export const EM_TOKEN_ADDRESS = "0xE283D0e3B8c102BAdF5E8166B73E02D96d92F688"
export const EM_TOKEN_ABI = [
  {
    inputs: [
      { internalType: "string", name: "name", type: "string" },
      { internalType: "string", name: "symbol", type: "string" },
      { internalType: "address", name: "exchangeRouter", type: "address" },
      { internalType: "uint256", name: "campaignPeriod", type: "uint256" },
    ],
  ...
  },
  {
    ...
    name: "graveyard",
    outputs: [
      { internalType: "contract ElephantGraveyard", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
